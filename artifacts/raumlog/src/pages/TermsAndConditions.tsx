        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <Section id="s3" title="3. Términos Relacionados al Servicio">
            ...
            <Sub title="3.5 Autoridad y Capacidad Jurídica">
              <p>Al acceder o utilizar el Sitio, usted indica que ha leído, comprende y acepta quedar obligado por estos Términos. El Sitio está destinado exclusivamente a personas con plena capacidad jurídica.</p>
            </Sub>
            <Sub title="3.6 Aviso de Gravamen">
          ...
          <Section id="s11" title="11. Reservas y Términos Financieros">
            ...
            <Sub title="11.4 Pagos recurrentes">
              <p>Para reservas de larga duración, el Usuario autoriza cobros automáticos en cada Fecha de Renovación.</p>
            </Sub>
          ...
          <Section id="s13" title="13. Responsabilidad del Usuario por Daños al Espacio">
            <p>Los Usuarios son responsables por los daños que ellos o sus Artículos Almacenados causen a la propiedad o al Espacio del Anfitrión. Para evitar disputas, se recomienda registrar el estado inicial del Espacio. RaumLog no es responsable por dichos daños.</p>
          </Section>
          ...
          <Section id="s25" title="25. Resolución de Disputas y Arbitraje">
            ...
            <Sub title="25.2 Tribunal de Arbitramento">
              <p>Toda controversia será dirimida por un tribunal de arbitramento administrado por el <strong>Centro de Conciliación, Arbitraje y Amigable Composición de la Cámara de Comercio de Medellín para Antioquia</strong>, conformado por:</p>
              <Ul>
