  ...
  return (
    <div className="border border-[#2C5E8D]/20 rounded-xl p-5 text-sm text-[#2C5E8D] space-y-4 bg-white">
      ...
      <div className="text-xs text-[#2C5E8D]/60 space-y-1.5 border-t border-[#AECBE9]/30 pt-3">
        ...
        <p><strong className="text-[#2C5E8D]">Cláusula 2 – Intermediación y Asunción de Riesgo:</strong> RaumLog actúa exclusivamente como intermediario tecnológico y agente de cobro; no es depositario, custodio ni aseguradora de los bienes. El Depositante declara conocer y aceptar que, al entregar los bienes al Depositario, asume de manera voluntaria e integral todos los riesgos derivados de su almacenamiento, incluyendo pérdida, deterioro, robo o daño. RaumLog no ofrece pólizas de seguro ni cobertura alguna sobre los bienes almacenados. El Depositante es el único responsable de gestionar, por su cuenta y riesgo, los seguros que considere necesarios (T&C §2.1, §22.2).</p>
      ...
      <p className="text-[9px] text-center text-[#2C5E8D]/30 border-t border-[#AECBE9]/20 pt-2">
        Intermediado por COALGE S.A.S. a través de la plataforma RaumLog · NIT 902.029.993-7 · contacto@raumlog.com
      </p>
    </div>
  );
}
