        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.facebook.com/raumlog" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-[#AECBE9] hover:text-white transition-colors">
