...
export default function Footer() {
  return (
    <footer className="bg-[#2C5E8D] text-white pt-10 pb-6 relative">
      ...
      <a
        href="https://api.whatsapp.com/send?phone=573054162141"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#1ebe5d] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-colors"
